    ...
    return (
      <div>
        {Object.keys(users).map((user) => (
          <div key={users[user].id} className='summary-container leaderboard-container'>
            ...
            <div className='lb-user-data-container'>
              ...
              <div className='lb-aq-container'>
                <div className='lb-aq-text'>Answered Questions</div>
                <div className='lb-aq-score'>{Object.values(users[user].answers).length}</div>
              </div>
              <div className='lb-aq-container'>
                <div className='lb-aq-text'>Created Questions</div>
                <div className='lb-aq-score'>{Object.values(users[user].questions).length}</div>
              </div>
            </div>
